...
import { Box, Flex, Icon, Text, ColorPicker } from '@chakra-ui/react';

export default function TimelineRow(props) {
	const { logo, title, date, color, index, arrLength } = props;
	const textColor = ColorPicker('gray.700', 'white.300');
	const bgIconColor = ColorPicker('white.300', 'gray.700');
